...
('Encanamento', 'Profissional especializado em instalação e manutenção de sistemas hidráulicos e encanamentos.'),
('Construção', 'Profissional que atua em obras civis, reformas e construção de edificações.');